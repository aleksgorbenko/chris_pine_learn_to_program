...
def english_number number
  ...
  write = left/1000           # How many thausands left?
  left = left - write * 1000  # Subtract off those thausands.

  if write > 0
    thausands = english_number write
    num_string = num_string + thausands + ' thausand'
...
bottles = gets.chomp.to_i
  ...
  puts "All bottles are gone now, gentlemen"
